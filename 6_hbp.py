...
class HBP(nn.Module):
    ...
    def __init__(self, feature_size = 300, hidden_size = 16, L = 8, classes_num = 5, etha = 0.1, betha = 0.99, s = 0.2):
    ...
    def partial_fit(self, x, y):
        ...
        for i in range(self.L):
            losses.append(criterion(fs[i], y))
        ...
        ##########################################################################
        ###### Total Loss is a weighted combination of classifiers' losses. ######
